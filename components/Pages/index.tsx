...
const Page: PageEl = (
  ...
  return (
    <div style={{ direction: "rtl", minHeight: "11vh" }}>
      ...
      >
        <f-cse style={{ height: 50, width: "100%", fontSize: 50 }}>
          <f-14>مجموع قابل پرداخت:{total_price.toLocaleString("fa-IR")}</f-14>

          <f-14>تعداد کتاب:{state.cart.length.toLocaleString("fa-IR")}عدد</f-14>

          <c-x style={{minHeight:"11"}}> turing </c-x>

        </f-cse>
      </Window>
      <Window
        title={"خوش آمدید"}
        style={{ minHeight: 800, margin: 15, width: "calc(100% - 20px)" }}
      >
